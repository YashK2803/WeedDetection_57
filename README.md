...
## Introduction
This repository contains the implementation of various semi-supervised learning approaches for weed detection in sesame crop fields. The project was developed as part of the *Semi-Supervised Weed Detection Challenge* organized by *4i Labs, KRITI'25, Technical Board, IIT Guwahati*.
