...
## Introduction
This repository presents our implementation of multiple semi-supervised learning strategies for weed detection in sesame crop fields. The project was developed as part of the Semi-Supervised Weed Detection Challenge, organized by 4i Labs, KRITI’25, organized by the Technical Board, IIT Guwahati.

The primary objective of this challenge is to enhance weed detection accuracy while minimizing the reliance on large annotated datasets. Participants are tasked with leveraging a small set of labeled images in conjunction with a larger pool of unlabeled data to effectively train an object detection model using semi-supervised techniques.
